...
if (isset($_POST['send'])) {
    ...
    $railway = htmlentities($_POST['railway']);
    $productName = htmlentities($_POST['productName']);
    $serial = htmlentities($_POST['serial']);
    $manufacturing = htmlentities($_POST['manufacturing']);
    $failure = htmlentities($_POST['failure']);
    ...
    $messageBody .= "Railway Shed - Production Unit: $railway<br>";
    $messageBody .= "Product Name : $productName<br>";
    $messageBody .= "Product Name - Unit Serial Number: $serial<br>";
    $messageBody .= "Date Of Manufacturing: $manufacturing<br>";
    $messageBody .= "Date Of Failure or Problem Reported: $failure<br>";
...
.envelope{
                            ...
                            <div class="header-navigation__nav header-navigation__nav--style3 position-static">
                                <nav class="header-center">
                                    <ul>
                                        ...
                                        <li class="has-children has-children--multilevel-submenu">
                                            <a style="font-size: 20px;color: #F55C01;" href="#">SUPPORT</a>
                                            <ul class="submenu">

                                                <li><a style="color:#F55C01" href="service_req_form.php">Service req.Form
                                                    </a></li>
    ...
    <div class="page-content-wrapper section-space--inner--bottom--120 background-image">
        <div class="container">
            <div class="row mt-5">
                <div class="col-lg-8 offset-lg-2">
                    <div class="career-title-area text-center section-space--bottom--50">
                        <h2 class="title" style="color:#000">Service Request Form</h2>
                        <p class="subtitle">Your Needs, Our Expertise: Service Request Form</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-9 mx-auto">
                    <div class="contact-form-wrapper">
                        <form class="display-grid row-gap-1-rem" method="post" enctype="multipart/form-data">
                            <input class="box-shadow-primary" name="firstname" type="text" placeholder="Name *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="email" type="email" placeholder="Email" autocomplete="off" required />
                            <input class="box-shadow-primary" name="mobileNumber" id="mobile" type="number" placeholder="Mobile Number *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="subject" type="tel" placeholder="Subject *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="railway" type="text" placeholder="Railway Shed - Production Unit *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="productName" type="text" placeholder="Product Name *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="serial" type="text" placeholder="Product Name - Unit Serial Number *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="manufacturing" type="text" placeholder="Date Of Manufacturing *" autocomplete="off" required />
                            <input class="box-shadow-primary" name="failure" type="text" placeholder="Date Of Failure or Problem Reported *" autocomplete="off" required />
                            <label for="file">Attach File If Any</label>
                            <input class="box-shadow-primary file" type="file" name="image" id="image" placeholder="file" autocomplete="off" required />
    ...
    <script>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var nameInput = document.querySelector('input[name="firstname"]');

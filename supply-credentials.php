...
@media (min-width:700px) and (max-width:767px){
    ...
    <div class="header-area background-image">
        ...
        <div class="header-area " style="background-color:unset !important">
                                        ...
                                        <ul>
                                            ...
                                            <li class="has-children has-children--multilevel-submenu">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li> <a style="color: #F55C01;" href="supply-credentials.php">Supply Performance Credentials</a> </li>
            ...
            <div class="container" style="margin-top: 60px;">
                <div class="row " >
                    <div class="col-md-4">
                        <div class="credentails">
                            <div class="custom-credentials">
                                <img src="assets/img/supply-performance-images/DNI.png" alt="">
                                    ...
                                    <div class="popup-close-button">
                                        ...
                                        <form method="post" class="form-container1">
                                            ...
                                            <div>
                                                ...
                                                <div class="button">
                                                    <button type="submit" onclick="showPopup()" name="send">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="credentails">
                            <div class="custom-credentials">
                                <img src="assets/img/supply-performance-images/3PMC.png" alt="">
                                <button onclick="openPopup()">Download</button>
                                ...
                                <div class="popup-form-container">
                                    <div class="popup-close-button">
                                        ...
                                        <form method="post" class="form-container1">
                                            ...
                                            <h1 class="mb-3" style="color:#00204A;text-transform: uppercase;">Please Fill the Form for the Approval Of Download</h1>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="credentails">
                            <div class="custom-credentials">
                                <img src="assets/img/supply-performance-images/FDE.png" alt="">
                                <button onclick="openPopup()">Download</button>
                ...
                <div class="row mt-res" style="margin-top:40px;padding-top: 40px;padding-bottom: 40px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="credentails">
                            <div class="custom-credentials">
                                <img src="assets/img/supply-performance-images/VCD.png" alt="">
                                <button onclick="openPopup()">Download</button>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="credentails">
                            <div class="custom-credentials">
                                <img src="assets/img/supply-performance-images/STMC.png" alt="">
                                <button onclick="openPopup()">Download</button>
            ...
            <nav class="offcanvas-navigation">
                <ul>
                    ...
                    <li class="has-children">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="#">Supply Performance Credentials</a>
                            </li>
                            <li>
                                <a href="./statutary-credentials.php">Statutary Credentials</a>
                            </li>

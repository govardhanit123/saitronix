...
@media (min-width:526px) and (max-width:600px){
        ...
        <div class="header-area__desktop header-area__desktop--style3 " style="margin-top: 45px;">
            ...
            <div class="header-wrapper header-wrapper--style3 mt-36 ">
                <div class="responsive" style="position: absolute;top: 8px;">
                    <img src="/assets/img/logo/Logo.png" style="width: 49%;  margin-top: 3px;" class="img-fluid logo w-38 ml-6" alt="">
                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-children has-children--multilevel-submenu">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="has-children">
                                                    <a style="color: #F55C01;" href="#">Diesel Locomotive</a>
                                                    <ul class="submenu">
                                                        <li>
                                                            <a style="color: #F55C01;" href="#">Diesel
                                                                Master Controller</a>
    ...
    <section>
        <img src="/assets/img/products/diesel (1).png" alt="">
    </section>
    <!-- Products section 1 -->
            ...
            <div class="row" style="padding-top: 50px">
                <div class="col-md-6">
                    ...
                    <p style="margin-top: 10px;font-size: 19px;text-align: justify;font-weight: 500;color: #000;">
                        Saitronix electro drives pvt. Ltd . has designed & developed the Diesel Master Controller Controller imbibing
                ...
                <div class="col-md-6" style="margin-top: 30px;">
                    <img src="/products/d-master.png" style="margin-top: -40px;" alt="">
                </div>
            </div>
  ...
  <section style="padding:54px;" class="background-image res-padding">
        ...
        <div style="color: #000;font-size: 19px;">
            ...
            <div style="display:flex;align-items:baseline">
                ...
                <p>Universal Master controller designed for use in all types of diesel locomotives.
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem;">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Uses a indigenously designed non contact potentio- meter technology using hall effect based reed switches, which heat sink technology.
            ...
            <div class="py-3" style="display:flex;align-items:baseline">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Closed frame design to eliminate water ingress.

...
@media (min-width:700px) and (max-width:767px){
  ...
  @media (min-width: 700px) and (max-width: 767px){
                                        ...
                                        <ul>
                                            ...
                                            <li class="has-children has-children--multilevel-submenu">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li class="has-children">
                                                        <a style="color: #F55C01;" href="#">Electrical Multiple Units</a>
                                                        <ul class="submenu">
                                                            <li>
                                                                <a style="color: #F55C01;" href="/products/Electrical-multiple-units/emc.php">EMU
                                                                    Master Controller</a>
    ...
    <section>
        <img src="/assets/img/products/emu (1).png" alt="">
    </section>
    <!-- products section 1 -->
            ...
            <div class="row" style="padding-top: 50px;">
                <div class="col-md-6">
                    ...
                    <p style="font-size: 19px;text-align: justify;font-weight: 500;margin-top: 30px;color: #000;">
                        Master Controller is a crucial man & machine interface module to control the powering up, control
                        and running of the rolling stock. Hence it is a combined master cum brake controller, integrated
                        into a single unit with step less movement. The controller is designed with reliable and rugged
                        mechanical modules to ensure trouble-free performance. Further, the Master Controller compact
                        & modular designs occupies less space on driver console, with less maintenance and minimize
                        equipment downtime for attending repairs or periodic overhauling.
                        <br>
                    <p style="margin-top: 10px;font-size: 19px;text-align: justify;font-weight: 500;color: #000;">
                        Saitronix electro drives pvt. Ltd . has designed & developed the 3 Phase EMU Master Controller imbibing
                        the above parameters into the system and also emphasizing the need to minimize the mechanical
                        moving & rubbing parts and electrically more reliable switching contacts, to improve the reliability
                        and to minimize the periodic maintenance.</p>
                    </p>
                </div>
                <div class="col-md-6" style="margin-top: 30px;">
                    <!-- <img src="/products/3-phase-1.png"  style=" filter: drop-shadow(5px 20px 5px #d3753c);margin-top: -57px;"
 alt=""> -->
                    <img src="/products/emu.png" alt="">
                </div>
            </div>
    ...
    <!-- Description section -->
     ...
     <section style="padding:54px;" class="background-image res-padding">
        ...
        <div style="color: #000;font-size: 19px;">
            <p>India's first indigenously designed master controllers for EMU and metro applications
            </p>
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                ...
                <p>Retrofittable with gessman , schaltbau, alfaunion master controller.
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Indigenously design rotary encoder with customizable output like current , BCD, voltage etc.
            ...
            <div class="py-3" style="display:flex;align-items:baseline;">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Incorporated indigenously designed snap action switches which are proven with reliability.

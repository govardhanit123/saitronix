...
@media (min-width:700px) and (max-width:767px){
    ...
    height:715px !important;
      ...
      @media (max-width: 767px) {
        ...
        @media (max-width:767px) {
          ...
          section.background-image.padding-res {
                                        ...
                                        <li class="has-children has-children--multilevel-submenu">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="has-children">
                                                    <a style="color: #F55C01;" href="#">Electric Locomotive</a>
                                                    <ul class="submenu">
                                                        <li>
                                                            ...
                                                            <a href="../Electro-Locomotives/vcd.php">Vigilance
                                                                Control Device</a>
                                                            <a style="color: #F55C01;" href="../Electro-Locomotives/stmc.php">Stick Type
                                                                Master Controller</a>
    ...
    <section>
        <img src="/assets/img/products/smp.png" alt="">
    </section>
    <!-- products section 1 -->
        ...
        <div class="intro" style="padding: 0px 70px;">
            <div class="row" style="padding-top: 50px;">
                <div class="col-md-6">
                    ...
                    <p style="font-size: 19px;text-align: justify;font-weight: 500;margin-top: 30px;color: #000;">Stick Type Master Controller is a crucial man &amp; machine interface module to control the powering
                        up, control and running of the Locomotive. Hence it requires reliable and ruggedized design to
                        ensure trouble-free performance. Further, the Stick Type Master Controller should require less
                        maintenance and shall minimize equipment downtime for attending repairs or periodic
                        overhauling. In addition to this the Stick Type Master Controller should be designed in such a way
                        that it shall occupy less space and shall be convenient &amp; comfortable to be operated by the
                        driver/pilot while sitting in his seat. <br>
                    <p style="margin-top: 10px;font-size: 19px;text-align: justify;font-weight: 500;color: #000;">The Saitronix Electro Drives pvt ltd has designed &amp; developed the Stick Type Master Controller
                        imbibing the above parameters into the system and also emphasizing the need to minimize the
                        mechanical moving &amp; rubbing parts and electrically more reliable switching contacts, to improve
                        the reliability and to minimize the periodic maintenance.</p>
                    </p>
                </div>
                <div class="col-md-6" style="margin-top: 30px;">
                    <img src="/products/stick-type-master.png" alt="">
                </div>
            </div>
    ...
    <!-- Description section -->
     ...
     <section style="padding:54px;" class="background-image padding-res">
        <h3 style="color: #052148;font-weight: 900;font-size: 27px;">DESCRIPTION</h3>
        <div style="color: #000;font-size: 19px;">
            <p>Stick Type Master Controller is a specialized handheld device used for precise control and navigation in various industrial and technological applications.
                </p>
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                ...
                <p> Used in both conventional an microprocessor based tap changer Electric Locomotives.
                </p>
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>More than 800 units are working in the locomotives for last 7 years.
                </p>

            </div>
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Single unit can be interchangeable with conventional and micro process locomotives.
                </p>

            </div>
            <div class="py-3" style="display:flex;align-items:baseline;">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p> Ergonomically designed & one to one retrofit table with existing master controller
                </p>
            ...
            <div class="download" style="position: relative;">
                ...
                <h3 style="color: #052148;font-weight: 900;font-size: 27px;text-align: center;"> Product Details : <span style="font-size: 22px;font-weight: 500;" class="mx-2 spec">Specifications and Information</span> </h3>
            ...
            <footer class="footer " style="width: 100%;background-size: cover;">
                ...
                <div class="footer-row row" style="margin-top: 45px;">
                    ...
                    <div class="footer-col office-section">
                        <h3 class="office" style="color: #fff;font-weight: 700;">Office <div class="bottom-line"><span></span>
                            </div>

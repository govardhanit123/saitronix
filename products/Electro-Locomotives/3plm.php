...
span.mx-2.spec{
                                                    ...
                                                    <ul class="submenu">
                                                        <li>
                                                            ...
                                                            <a href="/products/Electro-Locomotives/stmc.php">Stick Type
                                                                Master Controller</a>
                                                            <a style="color: #F55C01;" href="/products/Electro-Locomotives/3plm.php">3 Phase
    ...
    <section>
        <img src="/assets/img/products/3-phase-master-controller.png" alt="">
    </section>
    <!-- products section 1 -->
        ...
        <div class="intro" style="padding: 0px 70px;">
            <div class="row" style="padding-top: 50px;">
                <div class="col-md-6">
                    ...
                    <p class="description">The 3 Phase Master Controller is designed as per CLW Specification No: CLW/ES/3/0031 ALT‐I. It
                        is used in WAG9,WAP7 &amp; WAP 5 class of 3 Phase electrical locomotive. The Master Controller is
                        the heart of the locomotive and allows the loco pilot. <br>
                    <p class="description" style="margin-top: 10px;"> a. To select the drive direction of the locomotive i.e. forward or reverse.
                        b. Regulate the tractive &amp; breaking effort of the locomotive.
                        The master controller has been designed indigenously by using the latest angle position
                        transmitter along with field proven cam switches. The 3 phase master controller complies with
                        IEC60571 &amp; 60077.
                    <p class="description" style="margin-top: 10px;">
                        There are three major functional components in the Master Controller <br>
                        a. Drive Direction Selector <br>
                        b. Drive Break Handle <br>
                        c. Angular Position Transmitter.
                    </p>

                    </p>
                </div>
                <div class="col-md-6" style="margin-top: 30px;">
                    <img src="/products/3-phase-1.png" style=" filter: drop-shadow(5px 20px 5px #d3753c);margin-top: -57px;" alt="">
                    <img src="/products/3-phase-2.png" style="margin-top: -40px;" alt="">
                </div>
            </div>
   ...
   <section style="padding:54px;" class="background-image res-padding">
        ...
        <div style="color: #000;font-size: 19px;">
            <p>3 Phase Loco Master Controller is an advanced electronic device designed for efficient and precise control of three-phase locomotives, ensuring smooth operation and safety in rail transport systems.
            </p>
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                ...
                <p>Electro Mechanical product with indigenized position sensor.
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p> More than 3000 Nos of master controller currently in field in the entire Indian railways.
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p> Indigenous designed forward and reverse switch.
            ...
            <div class="py-3" style="display:flex;align-items:baseline;">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Indigenous designed Angle Position Transmitter.

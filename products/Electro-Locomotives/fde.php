...
@media (min-width:700px) and (max-width:767px){
                                                ...
                                                <li class="has-children">
                                                    ...
                                                    <ul class="submenu">
                                                        <li>
                                                            ...
                                                            <a style="color: #F55C01;" href="../../Electro-Locomotives/fde.php">Fire
    ...
    <section>
        <img src="/assets/img/products/fire (1).png" alt="">
    </section>
    <!-- products section 1 -->

    <section style="background-image: linear-gradient(to right, #fff, #f55c01);padding-bottom: 30px;">

        <div class="intro">
            <div class="row">
                <div class="col-md-6 fde-des" style="padding: 45px 70px;">
                    ...
                    <p style="font-size: 19px;text-align: justify;font-weight: 500;margin-top: 30px;color: #000;">
                        Saitronix has designed the new system “AIR SAMPLING SMOKE/FIRE DETECTION UNIT”
                        which provides the early warning by detecting the presence of smoldering fires through
                        its opto electronic smoke detectors 1 &amp; 2 which is controlled by Programmed advanced
                        Micro Controller with visual indicators and messages display on LCD .

                    </p>
                </div>
                <div class="col-md-6">

                    <img src="/products/fire-2.png" style=" filter: drop-shadow(5px 20px 5px #d3753c);display: block; margin-left: auto; margin-right: auto;  width: 80%;" alt="">
                    <img style=" filter: drop-shadow(5px 20px 5px #d3753c);display: block; margin-left: auto; margin-right: auto;  width: 80%;" alt="" src="/products/fire-1.png" style="margin-top: -22px;" alt="">
                </div>
            </div>
   ...
   <section style="padding:54px;" class="background-image res-padding">
        ...
        <div style="color: #000;font-size: 19px;">
            <p>Fire detector equipment utilizes advanced sensors to detect smoke, heat, or flames, providing crucial
                early warnings in the event of a fire, ensuring rapid response and safety
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                ...
                <p>Electronic product
                    with indigenes design power supply & dsp modules.</p>

            </div>
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>With automatic
                    calibration and adaptable to different air flows.
                </p>
            ...
            <div style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p>Intelligent
                    detection of pipe breakage and pipe blockage.
                </p>

            </div>
            <div class="py-3" style="display:flex;align-items:baseline;padding-top:1rem">
                <img class="mx-2" style="width: 27px;" src="/assets/img/products/arrow.png" alt="">
                <p> Interactive LCD
                    display.
                </p>

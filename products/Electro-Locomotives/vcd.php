...
@media (min-width:700px) and (max-width:767px){
                                                    ...
                                                    <ul class="submenu">
                                                        <li>
                                                            <a href="../Electro-Locomotives/dni.php">Digital
                                                                Notch Indicator</a>
                                                            <a style="color: #F55C01;" href="../Electro-Locomotives/vcd.php">Vigilance
                                                                Control Device</a>
    ...
    <section>
        <img src="/assets/img/products/vcd.png" alt="">
    </section>
    <!-- products section 1 -->
            ...
            <div class="row" style="padding-top: 50px;">
                <div class="col-md-6">
                    ...
                    <p style="font-size: 19px;text-align: justify;font-weight: 500;margin-top: 30px;color: #000;">
                        Vigilance Control Device (VCD) monitors alertness of the driver on continuous basis by
                        checking his actions while running a train.VCD monitors various signal inputs from loco
                        through which driver’s alertness can be monitored. In the absence of loco signal inputs,
                        the driver has to press Foot switch within the specified time intervals when the train is
                        in movement. VCD system monitors the various signals (Detailed in the later sections of
                        the document) in predefined time.
                        <br>
                    <p style="margin-top: 10px;font-size: 19px;text-align: justify;font-weight: 500;color: #000;"> The pre defined time is classified into three types of
                        cycles and these cycles are executed in a specified time frame. By pressing the any input
                        signal within the specified time period, the cycle execution process will get reset. If the
                        driver doesn’t activate any input signal, then the VCD considers the loco as an
                        unmanned loco and hence a penalty brake is applied to stop the locomotive for the
                        safety of the passengers and also for the safety of the Locomotive.</p>
                    </p>
                </div>
                <div class="col-md-6" style="margin-top: 30px;">
                    <img src="/products/vcd-1.png" style=" filter: drop-shadow(5px 20px 5px #d3753c);
" alt="">
                    <img src="/products/vcd-2.png" alt="">
                </div>
            </div>
    ...
    <section style="padding:54px;" class="background-image res-padding">
        ...
        <div style="color: #000;font-size: 19px;">
            <p>Electronic Product with in house designed power supply & dsp boards.
                .</p>
            ...
            <p>VCD is used to monitor the alertness of the loco pilot during the operation of the locomotive , by
                sensing various functions performed by the LOCO Pilot like Horn, MP, A9 ,SA9 ,Sander etc.
            </p>
            <p>If these signals are not received by the VCD during a specified time interval it will apply the penalty
                break using IP valve for the safety of the passengers and locomotives.
            </p>

            <p>VCD will store around 1 lakh events at the give point of time which can be retrieved through front end
                software.

...
if (isset($_POST['send'])) {
    ...
    $productInterested = htmlentities($_POST['productInterested']);

    $messageBody = "Name: $name<br>";
    $messageBody .= "Email: $email<br>";
    $messageBody .= "Subject: $subject<br>";
    $messageBody .= "Message: $message<br>";
    $messageBody .= "Company Name: $companyName<br>";
    $messageBody .= "Information: $information<br>";
    $messageBody .= "Application: $application<br>";
    $messageBody .= "Product Interested: $productInterested<br>";
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-children has-children--multilevel-submenu">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="quality_policy.html">Quality
                                                        Policy</a></li>
                                                <li><a href="r&d.html">Research and
                                                        Development</a></li>
                                        ...
                                        <li class="has-children has-children--multilevel-submenu">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a style="color:#F55C01" href="enquiry-form.php">Enquiry Form
                                                    </a></li>
                                            </ul>
                                        </li>
                                        <li>
            ...
            <div class="row mt-5">
                <div class="col-lg-8 offset-lg-2">
                    <div class="career-title-area text-center section-space--bottom--50">
                        <h2 class="title" style="color:#000">Enquiry Form</h2>
                        <p class="subtitle">Your Desires, Our Solutions: Sales Inquiry Form</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-9 mx-auto">
                    <div class="contact-form-wrapper">
                        <form class="display-grid row-gap-1-rem" method="post">
                            ...
                            <input class="box-shadow-primary" name="companyName" type="text" placeholder="Company Name" autocomplete="off" required />
                            <input class="box-shadow-primary" name="information" type="text" placeholder="information" autocomplete="off" required />
                            <input class="box-shadow-primary" name="application" type="text" placeholder="Application" autocomplete="off" required />
                            <select class="railway" name="productInterested" id="railway" required>
                                <option value="" disabled selected>Product Interested</option>
                                <option value="option1">Digital Notch Indicator </option>
                                <option value="option2">Vigilance Control Device</option>
                                <option value="option3">Stick Type Master Controller</option>
                                <option value="option4">3 Phase Loco Master Controller</option>
                                <option value="option5">Fire Detector Equipment </option>
                                <option value="option6">Master Controller For Diesel Locomotives </option>
                                <option value="option7">Master Controller For EMU/Metro </option>
                                <option value="option8">Angle Transducer </option>
